...
import sch.id.smkn4palembang.databinding.FragmentVisitorStudentsBinding
...
class VisitorStudentsFragment : Fragment() {

    private var _binding: FragmentVisitorStudentsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVisitorStudentsBinding.inflate(inflater, container, false)
